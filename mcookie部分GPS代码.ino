...
#define SSID        "nova4" //改为你的热点名称, 不要有中文
#define PASSWORD    "06091212"//改为你的WiFi密码Wi-Fi密码
#define DEVICEID    "560306326" //OneNet上的设备ID
String apiKey = "YPHVwKAlmLKM8JUa2=iQyYpxKa8=";//与你的设备绑定的APIKey
